	...
	handleSidebarClick(event) {
		...
		if ($clickedItem) {
			...
			this.$sidebarItems.forEach(item => {
				...
				item.querySelector('.material-symbols-outlined').classList.remove('active');
			});

			// Add active class to clicked item
			$clickedItem.classList.add('active-item');
			$clickedItem.querySelector('.material-symbols-outlined').classList.add('active');

			// Toggle archive view based on clicked item
			const iconText = $clickedItem.querySelector('.material-symbols-outlined').textContent.trim();
